...
const CATEGORY_COLORS = {
  "전광|빌보드|외벽": ["rgba(255,170,200,0.95)", "rgba(0,0,0,0.35)"],

  "교통|버스|지하철|택시|철도": ["rgba(162,222,204,0.95)", "rgba(0,0,0,0.35)"],

  "복합|쇼핑|몰|마트|백화점": ["rgba(255,240,160,0.95)", "rgba(0,0,0,0.35)"],

  "극장|영화|레저|테마|파크": ["rgba(255,200,150,0.95)", "rgba(0,0,0,0.35)"],

  "생활|병원|약국|편의점|주유소": ["rgba(220,190,255,0.95)", "rgba(0,0,0,0.35)"],
};
